...
#let ams-article(
  ...
  show link: set text(font: "New Computer Modern Mono", fill: rgb(0, 0, 255, 1))
...
#let temp_fira_raw(data) = {
  block(width: 100%, align(center, text(font: "Fira Code", ligatures: true, [#data])))
}
